  ...
  if (overlayEl) {
    overlayEl.outerHTML =
      ...
      '<div class="confirm-overlay" id="overlay-os">' +
        '<div class="confirm-box" role="dialog" aria-modal="true" aria-labelledby="overlay-os-title">' +
          ...
          '</div>' +
          '<h3 id="overlay-os-title">Mein Desktop wird gestartet\u00a0...</h3>' +
      ...
      '<div class="confirm-overlay" id="overlay-academy">' +
        '<div class="confirm-box" role="dialog" aria-modal="true" aria-labelledby="overlay-academy-title">' +
          '<div class="confirm-icon academy-icon">' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.1 2.7 3 6 3s6-1.9 6-3v-5"/></svg>' +
          '</div>' +
          '<h3 id="overlay-academy-title">Weiterleitung zur Vibecoding Academy</h3>' +
